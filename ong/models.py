...
class action(models.Model):
    ...
    organisme = models.ForeignKey(organisme, verbose_name="organisme maitre d'oeuvre", to_field='nom', unique=True)
    avancement = models.ForeignKey('avancement', verbose_name="état d'avancement", to_field='nom', unique=True) # Un "avancement" peut concerner plrs "actions" mais une "action" ne peut avoir qu'un état d'"avancement" => ForeignKey
